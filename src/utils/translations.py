...
# Oldest first
TRANSLATORS = {
    'ar': { 'flag_code': '🇸🇦', 'user_ids': [595682186452271108, 631821494774923264, 588832324745953283] },
    'en_US': { 'flag_code': '🇺🇸', 'user_ids': [138751484517941259] },
    'da': { 'flag_code': '🇩🇰', 'user_ids': [135446225565515776, 420619125887467531] },
    'de': { 'flag_code': '🇩🇪', 'user_ids': [296573428293697536, 394264447151243286, 632485754643415053, 285665580760170496, 455816405791670285, 549911100980723714, 570323095542431786] },
    'es': { 'flag_code': '🇪🇸', 'user_ids': [500550140201926656, 647608852883177492, 632485754643415053, 709131461374246932, 549911100980723714] },
    'fr': { 'flag_code': '🇫🇷', 'user_ids': [138751484517941259, 296573428293697536, 465207298890006529, 632485754643415053, 668349394529157131, 643504268267225118, 119872860440231936, 549911100980723714] },
    'hu': { 'flag_code': '🇭🇺', 'user_ids': [579324767216336923] },
    'id': { 'flag_code': '🇮🇩', 'user_ids': [856895619469672449] },
    'it': { 'flag_code': '🇮🇹', 'user_ids': [549911100980723714] },
    ...
    'zh': { 'flag_code': '🇨🇳', 'user_ids': [790758041356206101, 354349329076584459, 628542777692782611] },
    'zh-Hans': { 'flag_code': '🇨🇳', 'user_ids': [790758041356206101, 354349329076584459, 628542777692782611, 570323095542431786] }
}
