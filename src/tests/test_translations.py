...
def check_po_file(file: Path) -> Tuple[bool, List[str], List[Embed]]:
...
def main():
    webhook_url = environ.get("L10N_WEBHOOK_URL", None)
    webhook = None
