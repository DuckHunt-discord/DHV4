...
ENV BOTSFORDISCORD_TOKEN="abcdef"
ENV BOTLIST_SPACE_TOKEN="abcdef"
ENV DISCORDEXTREMELIST_TOKEN="abcdef"
ENV VOIDBOTS_TOKEN="abcdef"
ENV INFINITYBOTLIST_TOKEN="abcdef"
ENV BLIST_TOKEN="abcdef"
ENV DISCORDAPPS_TOKEN="abcdef"
